...
export default async function Soulye() {
    ...
    <>
      ...
      <div style={{ backgroundColor: 'var(--color-surface)', padding: '3rem 0', textAlign: 'center' }}>
        <div className="container animate-fade-in">
          <h1 style={{ fontSize: '3rem', color: 'var(--color-primary)' }}>Soulye</h1>
          <p style={{ fontSize: '1.2rem', color: 'var(--color-text-light)' }}>
            Soulye elegant pou mesye ak medam.
          </p>
        </div>
      </div>
        ...
        <div className="container">
          {products.length > 0 ? (
            ...
            <p className="text-center" style={{ color: 'var(--color-text-light)', fontStyle: 'italic', padding: '4rem 0' }}>
              Pa gen soulye disponib kounye a.
            </p>
          )}
        </div>
      </section>
